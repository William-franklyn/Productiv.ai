...
-- ============================================================================
-- 018_finance.sql
-- Finance: one Nessie sandbox account per workspace, with pay_vendor
-- following the same human-approval-before-send shape as email_drafts.
-- ============================================================================
...
-- ============================================================================
-- 019_receipts.sql
-- A unified ledger of completed money movement, both directions, used for
-- balance calculation and "what happened in that transaction" chat lookups.
-- ============================================================================
...
-- ============================================================================
-- 020_sponsored_credits.sql
-- Sponsored workspace credits: Nessie moves money in, a Solana devnet memo
-- transaction anchors a public, anonymous record of what got spent. See
-- docs/sponsored-credits.md.
-- ============================================================================
...
-- ============================================================================
-- 021_organizations_update_policy.sql
-- organizations never had an update policy — member-facing writes to it
-- (rename, sponsor_slug) were silently no-ops under RLS.
-- ============================================================================
...
-- ============================================================================
-- 022_increment_organization_credit.sql
-- Atomic credit increment for the public sponsor-funding route.
-- ============================================================================
...
-- ============================================================================
-- 023_action_based_credits.sql
-- Sponsored credits move from "meter answers" to "meter actions" — every
-- chargeable thing (answer/task/meeting/email) gets its own usage_event
-- with its own cost. See docs/sponsored-credits.md.
-- ============================================================================
...
-- ============================================================================
-- 024_rename_credit_rpc_param.sql
-- increment_organization_credit's parameter renamed to match credit_balance
-- now being credit units, not lamports.
-- ============================================================================
