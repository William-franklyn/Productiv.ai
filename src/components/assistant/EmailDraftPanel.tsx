...
export function EmailDraftPanel({
  ...
  return (
    <aside className="flex h-[calc(100vh-3.5rem)] w-96 shrink-0 flex-col border-l border-[var(--border)] bg-[var(--surface)]">
        ...
        <div className="flex flex-1 flex-col gap-3 overflow-y-auto p-4">
          <label className="flex flex-col gap-1 text-[var(--text-xs)] text-[var(--muted)]">
            ...
            <input
              ...
              className="h-9 rounded-[var(--radius-sm)] border border-[var(--border)] bg-[var(--bg-primary)] px-2.5 text-[var(--text-sm)] text-[var(--ink)]"
            />
          </label>
          <label className="flex flex-col gap-1 text-[var(--text-xs)] text-[var(--muted)]">
            Subject
          ...
          <label className="flex flex-1 flex-col gap-1 text-[var(--text-xs)] text-[var(--muted)]">
            ...
            <textarea
              ...
              className="min-h-[16rem] flex-1 resize-none rounded-[var(--radius-sm)] border border-[var(--border)] bg-[var(--bg-primary)] p-2.5 text-[var(--text-sm)] text-[var(--ink)]"
            />
          </label>
